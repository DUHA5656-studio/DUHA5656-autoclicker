...
class BeautifulAutoClicker(QMainWindow):
    ...
    def apply_purple_styles(self):
        ...
        # Кнопки
        self.save_config_btn.setStyleSheet(self.get_button_style("#7b1fa2", "#9c27b0", "#6a1b9a"))
        self.load_config_btn.setStyleSheet(self.get_button_style("#9c27b0", "#bb86fc", "#7b1fa2"))
        self.start_btn.setStyleSheet(self.get_button_style("#bb86fc", "#e0b0ff", "#9c27b0"))
        self.stop_btn.setStyleSheet(self.get_button_style("#f44336", "#ff7961", "#ba000d"))
    ...
    def apply_pink_styles(self):
        ...
        # Кнопки
        self.save_config_btn.setStyleSheet(self.get_button_style("#ff69b4", "#ff85a2", "#ff1493"))
        self.load_config_btn.setStyleSheet(self.get_button_style("#ff85a2", "#ffa7b6", "#ff69b4"))
        self.start_btn.setStyleSheet(self.get_button_style("#ffb6c1", "#ffd1dc", "#ff85a2"))
        self.stop_btn.setStyleSheet(self.get_button_style("#ff6b6b", "#ff8f8f", "#ff4757"))
        ...
        return f"""
            QPushButton {{
                background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,
                    stop: 0 {base_color}, stop: 1 #ffffff);
                color: #4b0082;
            ...
            QPushButton:hover {{
                background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,
                    stop: 0 {hover_color}, stop: 1 #ffffff);
                border-color: {hover_color};
            }}
            QPushButton:pressed {{
                background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,
                    stop: 0 {pressed_color}, stop: 1 #ffffff);
