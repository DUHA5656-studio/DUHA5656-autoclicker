...
class BeautifulAutoClicker(QMainWindow):
    def __init__(self):
        ...
        title.setStyleSheet("color: #e91e63; margin: 10px;")
        ...
        self.accel_checkbox.setStyleSheet("color: #333333;")
        ...
        self.optimization.setStyleSheet("color: #333333;")
        ...
        self.save_config_btn.setStyleSheet(self.get_pink_button_style("#e91e63"))
        self.save_config_btn.clicked.connect(self.save_config)
        config_layout.addWidget(self.save_config_btn)
        
        self.load_config_btn = QPushButton("📂 Загрузить конфиг")
        self.load_config_btn.setStyleSheet(self.get_pink_button_style("#ec407a"))
        ...
        self.start_btn.setStyleSheet(self.get_pink_button_style("#f48fb1"))
        self.start_btn.clicked.connect(self.start_clicker)
        button_layout.addWidget(self.start_btn)
        
        self.stop_btn = QPushButton("⏹️ Остановить")
        self.stop_btn.setStyleSheet(self.get_pink_button_style("#f44336"))
    ...
    def set_pink_white_palette(self):
        ...
        # Основные цвета
        pink_white_palette.setColor(QPalette.Window, QColor(255, 245, 250))      # Основной фон
        pink_white_palette.setColor(QPalette.WindowText, QColor(51, 51, 51))     # Текст
        pink_white_palette.setColor(QPalette.Base, QColor(255, 255, 255))        # Фон полей ввода
        pink_white_palette.setColor(QPalette.AlternateBase, QColor(248, 187, 208)) # Альтернативный фон
        pink_white_palette.setColor(QPalette.ToolTipBase, QColor(255, 245, 250)) # Подсказки
        pink_white_palette.setColor(QPalette.ToolTipText, QColor(51, 51, 51))    # Текст подсказок
        pink_white_palette.setColor(QPalette.Text, QColor(51, 51, 51))           # Основной текст
        pink_white_palette.setColor(QPalette.Button, QColor(248, 187, 208))      # Кнопки
        pink_white_palette.setColor(QPalette.ButtonText, QColor(51, 51, 51))     # Текст кнопок
        pink_white_palette.setColor(QPalette.BrightText, QColor(255, 255, 255))  # Яркий текст
        pink_white_palette.setColor(QPalette.Link, QColor(233, 30, 99))          # Ссылки
        pink_white_palette.setColor(QPalette.Highlight, QColor(244, 143, 177))   # Выделение
    ...
    def get_pink_button_style(self, color):
        return f"""
            QPushButton {{
                background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,
                    stop: 0 {color}, stop: 1 #f8bbd0);
                color: white;
                border: none;
                padding: 12px;
                font-weight: bold;
            ...
            QPushButton:hover {{
                background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,
                    stop: 0 #ec407a, stop: 1 #f48fb1);
            }}
            QPushButton:pressed {{
                background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,
                    stop: 0 #d81b60, stop: 1 #e91e63);
            }}
